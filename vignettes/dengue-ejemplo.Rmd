...
```{r distribution_age, echo = FALSE, error = FALSE,  warning = FALSE, include = TRUE, message = FALSE, fig.height = 4, fig.width = 8, fig.cap =  "Distribucion de casos por edad y semana epidemiologica"}
...
```{r distribution_age_anger, echo = FALSE, error = FALSE,  warning = FALSE, include = TRUE, message = FALSE, fig.height = 3, fig.width = 8, fig.cap =  "Distribucion de casos por edad y genero"}
...
```{r distribution_sp, echo = FALSE, error = FALSE,  warning = FALSE, include = TRUE, message = FALSE, fig.height = 5, fig.width = 10, fig.cap =  "Distribucion de casos por poblacion especial"}
...
```{r map_distribution_spatial, echo = FALSE, error = FALSE,  warning = FALSE, include = TRUE, message = FALSE, fig.height = 6, fig.width = 10, fig.cap =  "Distribucion espacial de casos"}
departments_spacial_data <- group_by_deptos(clean_disease_data)
plot_dept_map(departments_spacial_data, map_title = "Colombia")
```
