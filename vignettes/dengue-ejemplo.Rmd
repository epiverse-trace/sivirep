...
La distribución de los casos por grupos etarios muestra una tendencia decreciente a medida que se avanza en la edad. La población menor de 10 años representó el   `r nrow(disease_data)` de todos los casos de Dengue en el país (Ver figura 5).
