---
title: "Análisis o reportes personalizados"
...
# Análisis o reportes personalizados
...
-   `sivirep` 0.0.9 está diseñado para ayudar con el acceso a la fuente
...
> :bulb: Tip 3 - Obtén la fila con más casos Al construir una sección
> del reporte o analizar estos datos, puede ser útil saber cuál es la
> variable que tiene la mayoría de los casos. En `sivirep`, puedes
> utilizar la función `obtener_fila_mas_casos` para obtener esta
