...
disease_dt_by_age_range <- group_by_range(disease_dt_by_age, "EDAD", min_val = 0, max_val = max(disease_dt_by_age$EDAD), 10)
...
disease_dt_by_age_gen <- group_by_variable(disease_dt_by_age, "EDAD", "SEXO", wt_percentage = TRUE)
