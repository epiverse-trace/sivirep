...
source("../R/analyticis-plotting/plotting.R")
source("../R/analyticis-plotting/build_endemic_channel.R")
```
...
sivigila_data <- import_data(link_data)
...
deptos_data    <- import_data("https://www.datos.gov.co/api/views/gdxc-w37w/rows.csv?accessType=DOWNLOAD")
...
```{r map2, echo=FALSE, error=FALSE, fig.height=5, fig.width=10, warning=FALSE, include=TRUE, message=FALSE}
