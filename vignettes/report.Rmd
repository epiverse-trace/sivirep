...
plot_by_parameter(disease_dt_by_age_range, var_x = "EDAD", var_y = "Casos", var_fill = "EDAD",label_x = "Edad", label_y = "Casos", scale_name = "Edad", scale_labels = disease_dt_by_age_range$EDAD, diagram_title = "Diagrama para la variable Edad", legend_pos = "bottom", bar_wd = 0.7, text_sz = 3)
