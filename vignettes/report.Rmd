...
source("../R/reports/build_reports.R")
source("../R/reports/build_endemic_channel.R")
```
...
#disease_data_by_years <- import_data_endemic_channel("MALARI", 2020)
#df_quartiles <- get_disease_quartiles(disease_data_by_years)
#plot_endemic_channel(df_quartiles)
