...
- the name of the municipality *(optional)*
- cache data *(checkbox - optional)*: Choose whether the downloaded data for the   event and incidence should be stored in the user's session cache to avoid re-downloading it when generating the report again with the same inputs.
...
[Custom analysis](https://epiverse-trace.github.io/sivirep/articles/custom_analysis_en.html) 
page.
