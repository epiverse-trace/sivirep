...
```{r}
depto_disease_codes_data <- get_depto_codes(geo_data_codes)
depto_disease_codes_data <- clean_depto_disease_codes(depto_disease_codes_data, disease_data, make_group = TRUE)
```
