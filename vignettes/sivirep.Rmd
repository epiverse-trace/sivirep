...
cases_onset_symptoms_by_day <- group_onset_symptoms(disease_data =
                                                      clean_disease_data,
                                                    type = "day")
cases_onset_symptoms_by_month <- group_onset_symptoms(disease_data =
                                                        clean_disease_data,
                                                      type = "month")
```
...
```{r}
cases_notification_date_by_day <-
  group_notification_date(disease_data = clean_disease_data,
                          type = "day")
cases_notification_date_month <-
  group_notification_date(disease_data = clean_disease_data,
                          type = "month")
```
...
```{r}
cases_sex <- group_sex(disease_data = filter_disease_data,
                       percentage = TRUE)
```
