...
deptos_code_disease_data <- clean_depto_disease_codes(depto_codes, deptos_code_disease_data, make_group = TRUE)
```
...
```{r}
map <- plot_dept_map(deptos_code_disease_data, col_name_lj = "id")
map
```
...
This function generates the report of the Epidemiological Week of the year 2019:
