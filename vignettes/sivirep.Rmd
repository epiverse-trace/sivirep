...
<!-- We need to link the online rather than local version because pkgdown doesn't support videos -->
![](https://github.com/epiverse-trace/sivirep/blob/gif2webm/man/figures/template.webm?raw=TRUE){width=900}

El reporte que obtendrás al utilizar la plantilla de `sivirep` es este:

<!-- We need to link the online rather than local version because pkgdown doesn't support videos -->
![](https://github.com/epiverse-trace/sivirep/blob/gif2webm/man/figures/template-report.webm?raw=TRUE){width=900}
