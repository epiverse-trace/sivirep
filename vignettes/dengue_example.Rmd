...
params:
  ...
  disease_name: "Dengue"
vignette: >
  %\VignetteIndexEntry{dengue_example}
...
cases_onset_symptoms_by_day <- group_onset_symptoms(clean_disease_data, 
                                                    type = "day")
...
cases_sex <- group_sex(clean_disease_data)
...
cases_special_population <- group_special_population(clean_disease_data)
