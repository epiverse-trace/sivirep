...
Función que estandariza los códigos geográficos de los datos de una
enfermedad o evento según la codificación del DIVIPOLA.
...
- data_event:
  ...
  con códigos geográficos.

## Value

Un \`data.frame\` con los códigos geográficos estandarizados de los
datos de una enfermedad o evento según la codificación del DIVIPOLA.
