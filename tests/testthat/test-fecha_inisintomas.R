...
test_that("`fecha_inisintomas` maneja errores correctamente", {
  ...
  expect_error(agrupar_fecha_inisintomas(data_event = list(a = 1, b = 2)),
               "El parametro data_event debe ser un data.frame")
  
  expect_error(agrupar_fecha_inisintomas(data_event = data_limpia,
                                         col_fecha = TRUE),
               "El parametro col_fecha debe ser una cadena de caracteres")
  
  expect_error(plot_fecha_inisintomas(data_agrupada = list(a = 1, b = 2)),
               "El parametro data_agrupada debe ser un data.frame")
  
  expect_error(plot_fecha_inisintomas(data_agrupada =
