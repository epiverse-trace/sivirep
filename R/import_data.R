...
#' @export
import_geo_codes <- function(url_data = config::get(
                               file =
                                 system.file("extdata", "config.yml",
                                   package = "sivirep"
                                 ), "geo_data_path"
...
#' @return A data frame
#' @examples
#' import_data_separator("https://www.datos.gov.co/api/views/qvnt-2igj/rows.csv?accessType=DOWNLOAD")
#' @export
...
#'
#' Function that imports the last five years of a disease data for building the endemic channel from SIVIGILA source
