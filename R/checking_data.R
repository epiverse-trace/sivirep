...
#' @param week The name of the week
#' @param wt_percentage Indicates if a percentage is required to the group
#' @return The disease data grouped by variable and/or week
#' @examples
#' group_by_variable(disease_data, week = "SEMANA",  = TRUE)
#' @export
...
#' @return The disease data grouped by the range
#' @examples
