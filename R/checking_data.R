...
get_special_population_cases <- function(disease_data) {
  ...
  disease_data_special_population <- data.frame(
...
#'
#' Function that groups the disease data by sex, epidemiological week and 
#' cases number
#' @param disease_data The disease data
#' @param col_names Column names in the disease data that contains the sex and 
