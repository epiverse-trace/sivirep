...
La incidencia fue calculada con `r text_incidencia_sex` para cada sexo por `r cond_incidencia$coeficiente` habitantes, se puede visualizar en la tabla 2 y figura 13.
...
* La incidencia para `r text_geo` es de `r incidencia_total$incidencia` por  `r cond_incidencia$coeficiente` habitantes.
