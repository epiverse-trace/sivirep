...
```{r distribution_cg_plot, fig.height = 5, fig.width = 9, fig.cap =  "Distribucion de casos por genero"}
plot_sex(casos_sex)
```
\newpage
...
```{r plot_cg_semanaepi, fig.height = 9, fig.width = 11, fig.cap =  "Distribucion de casos por genero y semana epidemiologica"}
...
```{r map_distribution_spatial, echo = FALSE, error = FALSE, warning = FALSE, include = TRUE, message = FALSE, cache = FALSE, results = FALSE, comment = FALSE, fig.height = 23.5, fig.width = 20, fig.cap =  "Distribucion espacial de casos"}
mapa
```
