...
`r if(params$mpio_distribution && params$departmento != "" && params$municipio == "") {"# Distribución de casos por municipio"} else if(params$municipio == "") {"# Distribución de casos por departamento"}`
