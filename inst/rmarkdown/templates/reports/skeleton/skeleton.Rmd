...
`r if (params$temporal_distribution) {"Los casos se distribuyen a lo largo de los meses de enero a diciembre de params$year, teniendo un mayor reporte en el mes de mes_mayor_casos tanto por fecha de inicio de síntomas (Ver Figura 1) como por fecha de notificación (Ver Figura 2)."}`
