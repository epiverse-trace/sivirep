...
La incidencia para el departamento de `r params$departamento` es: `r incidencia_dpto` por  `r cond_incidencia$coeficiente` habitantes.
...
`r if(params$spatial_distribution) {"# La incidencia según distribución geográfica"}`
