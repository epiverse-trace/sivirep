...
```{r plot_cases_by_onset_symptom_date, fig.height = 5, fig.width = 11, fig.cap = "Distribucion de casos por dia de inicio de sintomas \\label{fig_1}"}
plot_fecha_inisintomas(data_agrupada = casos_iniciosin_dia,
                       uni_marca = "semanaepi")
```
`\@ref(fig:plot_cases_by_onset_symptom_date)`
