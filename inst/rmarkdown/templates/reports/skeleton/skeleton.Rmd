...
```{r mapa-casos, results='hide', echo = FALSE, error = FALSE, warning = FALSE, include = FALSE, message = FALSE}
mapa <- plot_map(data_agrupada = dist_espacial_dpto)
```

```{r mapa, echo = FALSE, error = FALSE, warning = FALSE, include = TRUE, message = FALSE, cache = FALSE, results = FALSE, comment = FALSE, fig.height = 18, fig.width = 16, fig.cap = paste0("Incidencia según distribución geográfica - ", text_ext_geo), include = params$spatial_distribution}
mapa
```
