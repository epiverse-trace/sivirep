...
```{r plot_cases_by_years, fig.height = 5, fig.width = 11, fig.cap = "Distribución de casos en los últimos 5 años"}
...
```{r plot_tip_cas_by_years, fig.height = 7, fig.width = 13, fig.cap = "Distribución de casos en los últimos 5 años"}
...
```{r distribution_per_etn, fig.height = 4, fig.width = 9, fig.cap =  "Distribución de casos por pertenencia étnica", include = params$age_sex_distribution}
